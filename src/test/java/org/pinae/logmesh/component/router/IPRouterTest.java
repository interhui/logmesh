...
import org.pinae.logmesh.component.router.impl.IPRouter;
import org.pinae.logmesh.message.Message;

public class IPRouterTest {
	
	@Test
	public void testRoute() {
		Map<String, Object> parameters = new HashMap<String, Object>();
		parameters.put("file", "router/ip_router.xml");
		...
		assertEquals(message.getMessage(), "IP_ROUTER:192.168.0.105 Hui Firewall Log: 192.168.78.32 inbound stream");
		...
		router.porcess(message);
		assertEquals(message.getMessage(), "IP_ROUTER:192.168.0.104 Liu ASA Log: keep alived used 100ms");
